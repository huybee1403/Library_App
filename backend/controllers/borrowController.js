  ...
  borrowBook: async (req, res) => {
    try {
      ...
      if (!bookId) {
        return res
          .status(400)
          .json({ success: false, message: "book_id la bat buoc" });
      }
  ...
  returnBook: async (req, res) => {
    try {
      ...
      if (!borrowId) {
        return res
          .status(400)
          .json({ success: false, message: "borrowId khong hop le" });
      }
  ...
  getBookStatus: async (req, res) => {
    try {
      ...
      if (!bookId) {
        return res
          .status(400)
          .json({ success: false, message: "bookId khong hop le" });
      }
